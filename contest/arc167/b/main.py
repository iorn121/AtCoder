...
def main():
    ...
    # print(167*168*168*168*335//2 % MOD)
    # print(primes)
    modb = B % MOD
    ans = modb
    mod2 = modinv(2, MOD)
    ...
    for p, x in primes:
        ...
        # print((x*B % MOD+1))
    # print(ans*mod2 % MOD)
    print(ans*mod2 % MOD if flg else (ans-1)*mod2 % MOD)
    ...
    # ll ans = 1;
    # ll modb = B % MOD;
    # vector<ll> primes = prime_factorization(A);
    # for (auto p : primes) {
    #     ans *= (p.second * modb + 1) % MOD;
    #     ans %= MOD;
    # }
    ...
    #     cout << ans * modinv(2, MOD) % MOD << endl;
    # } else {
    #     cout << (ans * modinv(2, MOD) - 1 + MOD) % MOD << endl;
    # }
