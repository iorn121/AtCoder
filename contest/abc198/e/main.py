...
def main():
    ...
    for _ in range(N-1):
        ...
        G[a].append(b)
        G[b].append(a)
    path_set = collections.defaultdict(int)
    path_set[C[0]] = 1
    seen = set()
    ans = [0]
    ...
    # [{2},_{2,_7},_{1,_2,_7},_{8,_1,_2,_7},_{2,_7},_{8,_1,_2,_7}]
    # [{3},_{1,_3},_{1,_3,_4},_{1,_3,_4},_{1,_3,_4,_5},_{1,_3,_4,_5,_9},_{1,_2,_3,_4,_5,_9},_{1,_2,_3,_4,_5,_6,_9},_{1,_2,_3,_4,_5,_6,_9},_{1,_2,_3,_4,_5,_6,_9}]
    dfs(0, -1)
    ans.sort()
